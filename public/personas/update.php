                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="id_tipoPersona" class="class form-control" name="id_tipoPersona">
                                                ...
                                                foreach ($tipopersonas_datos as $tipopersonas_dato) {
                                                    $tipopersona_tabla = $tipopersonas_dato['name_tipoPersona'];
                                                    $id_tipoPersona = $tipopersonas_dato['id_tipoPersona']; ?>
                                                    <option value="<?php echo $id_tipoPersona; ?>" <?php if ($tipopersona_tabla == $name_tipoPersona) { ?> selected='selected' <?php } ?>>
                                                        <?php echo $tipopersona_tabla; ?>
                                                    </option>
                                                <?php
                                                }
                                                ?>
