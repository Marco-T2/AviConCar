...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Editar comprobante</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            ...
                            <h3 class="card-title"><i class="fa fa-window-maximize"></i> Nro de Referencia
                                <input type="text" value="<?php echo $id_comprobante_get ?>" style="text-align: center;" disable>
                            </h3>
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <select id="id_tipocomprobante" class="class form-control" name="id_tipocomprobante">
                                                ...
                                                foreach ($tipocomprobantes_datos as $tipocomprobantes_dato) {
                                                    $tipocomprobante_tabla = $tipocomprobantes_dato['name_tipocomprobante'];
                                                    $id_tipoPersona = $tipocomprobantes_dato['id_tipocomprobante']; ?>
                                                    <option value="<?php echo $id_tipocomprobante; ?>" <?php if ($tipocomprobante_tabla == $name_tipocomprobante) { ?> selected='selected' <?php } ?>>
                                                        <?php echo $tipocomprobante_tabla; ?>
                                                    </option>
                                                <?php
                                                }
                                                ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" name="num_comprobante" id="num_comprobante" class="form-control" placeholder="#" value="<?php echo $num_comprobante ?>" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label for="">Fecha</label>
                                            <input type="date" name="fecha_comprobante" id="fecha_comprobante" class="form-control" placeholder="" value="<?php echo $fecha_comprobante; ?>" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label for="">Hora</label>
                                            <input type="time" name="hora_comprobante" id="hora_comprobante" class="form-control" placeholder="" value="<?php echo $hora_comprobante; ?>" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <label for="">Descripcion</label>
                                        <input type="text" name="descripcion" id="descripcion" class="form-control" placeholder="Poner una descripcion" value="<?php echo $descripcion ?>" required>
                                    </div>
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <button style="float: right;" type="button" class="btn btn-primary" id="btn_registrar_comprobante2">Registrar</button>
                                                    ...
                                                    <script>
                                                        ...
                                                        $('#btn_registrar_comprobante2').click(function() {
                                                            ...
                                                            if (id_subCuenta == "" || id_persona == undefined || (debe <= 0 && haber <= 0)) {
                                                                ...
                                                                $('#tablaExistente2 tbody').append(filaTabla);
                                                        ...
                                                        function actualizarTotal() {
                                                            ...
                                                            $('#row_id_final').detach().appendTo($('#tablaExistente2 tbody'));
                                                        }

                                                        // Función para sumar los valores de una columna
                                                        function sumarColumna(indice) {
                                                            var total = 0;
                                                            $('#tablaExistente2 tbody tr').each(function() {
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm table-hover table-striped" id="tablaExistente2">
                                        <thead>
                                            <tr>
                                        ...
                                        <body>
                                            <?php
                                            $contador = 0;
                                            foreach ($detalleComprobantes_datos as $detalleComprobantes_dato) {
                                                $id_detallecomprobante = $detalleComprobantes_dato['id_detallecomprobante'];
                                            ?>
                                                <tr id="row_id_<?php echo $contador = $contador + 1 ?>">
                                                    <td>
                                                        <center><?php echo $contador; ?></center>
                                                    </td>
                                                    <td class="id_subCuenta" style="display: none;"><?php $detalleComprobantes_dato['id_subCuenta'] ?></td>
                                                    <td><?php echo $detalleComprobantes_dato['name_subCuenta'] ?></td>
                                                    <td class="debe" style="text-align: right;"><?php echo $detalleComprobantes_dato['debe'] ?></td>
                                                    <td class="haber" style="text-align: right;"><?php echo $detalleComprobantes_dato['haber'] ?></td>
                                                    <td class="descripcionComp"><?php echo $detalleComprobantes_dato['descripcion'] ?></td>
                                                    <td class="id_persona" style="display: none;"><?php echo $detalleComprobantes_dato['id_persona'] ?></td>
                                                    <td>
                                                        <center><?php echo $detalleComprobantes_dato['name_persona'] ?></center>
                                                    </td>
                                                    <td><button type="button" style="width: 100%;" name="remove_row" class="btn btn-danger btn-xs remove_row">-</button></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <script>
                                        $('#btn_crear_comprobante').click(function() {
                                            ...
                                            $('#tablaExistente2 tbody tr').slice(0, -1).each(function() {
                                                var detalle = {
