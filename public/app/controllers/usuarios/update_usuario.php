...
$sql_usuarios = "SELECT a.id_usuario as id_usuario, a.nombres as nombres, 
  a.usuario as usuario ,b.rol as rol , a.fyh_creacion as fyh_creacion ,a.password_user as password_user FROM tb_usuarios as a 
...
foreach ($usuarios_datos as $usuarios_datos) {
  ...
  $password_user = $usuarios_datos['password_user'];
}
